...
```{r pca-genes, fig.width = 11, fig.height = 10}
plot_ts_pca(
  cop1_timeseq, 
...
Here we print out 30 of the genes with highest $R^2$ value and 
...
```{r genes-de-trajectory, fig.width = 8, fig.height = 8, fig.wide = TRUE}
