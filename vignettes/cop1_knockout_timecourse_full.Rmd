...
.packages <- c("edgeR", "viridis", "vistimeseq", "Biobase", "tidyverse") 
...
cop1_eset <- readRDS(
  file = system.file(
    "extdata", "NGS1471_esetCounts.rds", 
...
cop1_vistimeseq <- vistimeseqFromExpressionSet(
  cop1_eset, time_column = "time", group_column = "genotype", 
...
```{r pca-genes, fig.width = 6, fig.height = 6}
plot_ts_pca(
  cop1_timeseq, 
