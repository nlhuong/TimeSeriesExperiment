...
cop1_eset <- readRDS("../inst/extdata/NGS1471_esetCounts.rds")
```
...
```{r go-enrich-clst-c2,  fig.width = 8, fig.height = 4, fig.wide = TRUE}
clst <- "C2"
plot_enrichment(
...
```{r go-enrich-clst-c6,  fig.width = 8, fig.height = 4, fig.wide = TRUE}
clst <- "C6"
plot_enrichment(
    enrich = enrich_res[[clst]], n_max = 15) +
  ggtitle(paste0("Cluster , ", clst, " enrichment"))
